  ...
  if (recipientName) {
    const newUrl = `https://puade.github.io/syarif-viska/?kepada=${recipientName}`;
    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("October 1, 2025 19:00:00").getTime();
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbwuu3BDU8nnCl2ZA-wgODuQfX33B-euLlUx_zbdYEk6SopwVHUF1WhQMloCtsibyL_Wjg/exec'; // Ganti dengan URL Web App Google Apps Script Anda
